...
\begin{minipage}{\linewidth}
	\includegraphics[width=1.\linewidth]{MKB/UE_03/Schnittgerade.png}
		\captionof{figure}{Rote Ebene = Bildebene \ensuremath{(x_1 = 0)}, blaue Ebene = Menge der möglichen Projektionsgeraden \ensuremath{(x_2 = x_3)}, grüne Gerade = Schnittgerade der beiden Ebenen diese bezeichnen wir als die Menge aller möglichen Punkte \ensuremath{E_1'}. Rote Achse = \ensuremath{E_1}, blaue Achse = \ensuremath{E_3}, grüne Achse = \ensuremath{E_2} }
\end{minipage}
...
\begin{center}
	...
	% The axes
	\draw[->,green] (xyz cs:x=1.5) -- (xyz cs:x=-2.5) node[above] {$x2 = x3$};
	\draw[->,red] (xyz cs:y=-1.5) -- (xyz cs:y=2.5) node[right] {$x$};
%	\draw[->] (xyz cs:z=-1.5) -- (xyz cs:z=2.5) node[above] {$E_1$};
	% The thin ticks
	...
	\draw[black] (xyz cs:x=-1,y=0)node[below]{$E_1'$}--(xyz cs:x=0,y=1) node[left]{$E_1$};
...
\begin{center}
	...
	% The axes
	\draw[->,green] (xyz cs:x=1.5) -- (xyz cs:x=-2.5) node[above] {$x_2= x_3$};
	\draw[->,red] (xyz cs:y=-1.5) -- (xyz cs:y=2.5) node[right] {$x$};
	%	\draw[->] (xyz cs:z=-1.5) -- (xyz cs:z=2.5) node[above] {$E_1$};
	% The thin ticks
	...
	\draw[black] (xyz cs:x=0,y=1)node[right]{$E_1$}--(xyz cs:x=-2,y=0) node[above]{$E_1'$};
...
\begin{center}
	...
	\draw[black] (xyz cs:x=-0.5,y=0)node[below]{$E_1'$}--(xyz cs:x=0,y=1) node[left]{$E_1$};
...
\begin{center}
	...
	\draw[black] (xyz cs:x=-0.707,y=0)node[below]{$E_1'$}--(xyz cs:x=0,y=1) node[left]{$E_1$};
